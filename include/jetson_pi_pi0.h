...
//                   non-NULL pointer to finite float32 proprioception values.
//                   PI0.5 accepts at most 8 semantic values, or an
//                   action_dim-wide provider tensor whose entries after the
//                   first 8 are zero padding, and serializes the first 8 into
//                   the Task/State/Action prompt. Legacy Pi0 accepts at most
//                   action_dim values and zero-pads shorter input.

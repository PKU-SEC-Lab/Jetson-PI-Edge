...
int32_t llm_chat_apply_template(
    ...
    if (tmpl == LLM_CHAT_TEMPLATE_CHATML) {
        ...
        // Pangu-Embed uses localized role markers in the prompt template.
        // Keep these literal markers unchanged; the model expects them.
        // Example: [unused9]<role>:<content>[unused10].
        // ...
        for (size_t i = 0; i < chat.size(); ++i) {

...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_FEED_FORWARD_LENGTH_AE,            "%s.intermediate_size_ae"              },
    { LLM_KV_EMBEDDING_LENGTH_AE,               "%s.embedding_length_ae"               },
    { LLM_KV_INFERENCE_STEPS,                   "%s.num_inference_steps"               },
    { LLM_KV_ACTION_STEPS,                      "%s.n_action_steps"                    },
    { LLM_KV_ACTION_DIM,                        "%s.max_action_dim"                    },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ACTION_IN,                            "action_in_proj" },
    { LLM_TENSOR_ACTION_OUT,                           "action_out_proj" },
    { LLM_TENSOR_ACTION_TIME_IN,                       "action_time_mlp_in" },
    { LLM_TENSOR_ACTION_TIME_OUT,                      "action_time_mlp_out" },
    { LLM_TENSOR_STATE_PROJ,                           "state_proj" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_STATE_PROJ,                 {LLM_TENSOR_LAYER_INPUT,     GGML_OP_MUL_MAT}},

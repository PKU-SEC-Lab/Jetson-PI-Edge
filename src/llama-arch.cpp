...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    // pi0.embedding_length_ae u32              = 1024
    // llama_model_loader: - kv  15:                   pi0.intermediate_size_ae u32              = 4096
    // llama_model_loader: - kv  16:                    pi0.num_inference_steps u32              = 10
    // llama_model_loader: - kv  17:                         pi0.n_action_steps
...
static const std::map<llm_arch, std::map<llm_tensor, const char *>> LLM_TENSOR_NAMES = {
    ...
    },
    {
        LLM_ARCH_PI0,
        {
            ...
            // { LLM_TENSOR_ATTN_NORM,       "ae.model.layers.%d.input_layernorm" },
            // { LLM_TENSOR_ATTN_Q,          "ae.model.layers.%d.down_proj" },
            // { LLM_TENSOR_ATTN_K,          "ae.model.layers.%d.gate_proj" },
            // { LLM_TENSOR_ATTN_V,          "ae.model.layers.%d.up_proj" },
            // { LLM_TENSOR_ATTN_OUT,        "ae.model.layers.%d.post_attention_layernorm" },
            // { LLM_TENSOR_FFN_NORM,        "ae.model.layers.%d.k_proj" },
            // { LLM_TENSOR_FFN_GATE,        "ae.model.layers.%d.o_proj" },
            // { LLM_TENSOR_FFN_DOWN,        "ae.model.layers.%d.q_proj" },
            // { LLM_TENSOR_FFN_UP,          "ae.model.layers.%d.v_proj" },
            // { LLM_TENSOR_OUTPUT_NORM,     "ae.model.norm" },
...
std::string LLM_TN_IMPL::str() const {
    // printf("DEBUG: LLM_TENSOR_ACTION_IN = %d\n", LLM_TENSOR_ACTION_IN);
    // printf("DEBUG: LLM_TENSOR_ACTION_OUT = %d\n", LLM_TENSOR_ACTION_OUT);
    // printf("DEBUG: arch=%d, tensor=%d, suffix=%s\n", arch, tensor, suffix ? suffix : "null");

...
struct llama_layer {
    ...
    struct ggml_tensor * attn_norm_dense = nullptr;
    struct ggml_tensor * attn_norm_dense_b = nullptr;
    ...
    struct ggml_tensor * ffn_norm_dense   = nullptr;
    struct ggml_tensor * ffn_norm_dense_b = nullptr;
...
struct llama_model {
    ...
    struct ggml_tensor * action_in   = nullptr; //pi0
    struct ggml_tensor * action_in_b  = nullptr; //pi0
    struct ggml_tensor * action_out   = nullptr; //pi0
    struct ggml_tensor * action_out_b   = nullptr; //pi0
    struct ggml_tensor * action_time_in = nullptr; //pi0
    struct ggml_tensor * action_time_in_b   = nullptr; //pi0
    struct ggml_tensor * action_time_out  = nullptr; //pi0
    struct ggml_tensor * action_time_out_b   = nullptr; //pi0
    struct ggml_tensor * state_proj   = nullptr; //pi0
    struct ggml_tensor * state_proj_b = nullptr; //pi0
    struct ggml_tensor * time_mlp_in = nullptr; //pi05
    struct ggml_tensor * time_mlp_in_b = nullptr; //pi05
    struct ggml_tensor * time_mlp_out = nullptr; //pi05
    struct ggml_tensor * time_mlp_out_b = nullptr; //pi05
    struct ggml_tensor * ae_output_norm = nullptr; //pi0
    struct ggml_tensor * ae_output_norm_dense = nullptr; //pi05
    struct ggml_tensor * ae_output_norm_dense_b = nullptr; //pi05
    ...
    // std::vector<llama_layer> ae_layers;

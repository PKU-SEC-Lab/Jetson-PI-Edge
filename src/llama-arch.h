...
enum llm_kv {
    LLM_KV_FEED_FORWARD_LENGTH_AE, //pi0
    LLM_KV_EMBEDDING_LENGTH_AE, //pi0
    LLM_KV_INFERENCE_STEPS, //pi0
    LLM_KV_ACTION_STEPS, //pi0
    LLM_KV_ACTION_DIM, //pi0
    LLM_KV_GENERAL_TYPE,
...
enum llm_tensor {
    ...
    LLM_TENSOR_ACTION_TIME_IN,
    LLM_TENSOR_ACTION_TIME_OUT,
    LLM_TENSOR_STATE_PROJ,
    LLM_TENSOR_TIME_MLP_IN,
    LLM_TENSOR_TIME_MLP_OUT,
    LLM_TENSOR_AE_OUTPUT_NORM_DENSE,
    LLM_TENSOR_ATTN_NORM_DENSE,
    LLM_TENSOR_FFN_NORM_DENSE,
};

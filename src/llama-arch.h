...
enum llm_kv {
    LLM_KV_FEED_FORWARD_LENGTH_AE,
    LLM_KV_EMBEDDING_LENGTH_AE,
    LLM_KV_INFERENCE_STEPS,
    LLM_KV_ACTION_STEPS,
    LLM_KV_ACTION_DIM,
    LLM_KV_GENERAL_TYPE,
...
enum llm_tensor {
    ...
    LLM_TENSOR_ACTION_IN,       // pi0
    LLM_TENSOR_ACTION_OUT,      // pi0
    LLM_TENSOR_ACTION_TIME_IN,  // pi0
    LLM_TENSOR_ACTION_TIME_OUT, // pi0
    LLM_TENSOR_STATE_PROJ,      // pi0
    LLM_TENSOR_TIME_MLP_IN,     // pi05
    LLM_TENSOR_TIME_MLP_OUT,    // pi05
    LLM_TENSOR_AE_OUTPUT_NORM_DENSE, // pi05
    // GR00T N1.7 action head
    LLM_TENSOR_GR00T_VLLN,
    LLM_TENSOR_GR00T_VL_ATTN_Q,
    LLM_TENSOR_GR00T_VL_ATTN_K,
    LLM_TENSOR_GR00T_VL_ATTN_V,
    LLM_TENSOR_GR00T_VL_ATTN_OUT,
    LLM_TENSOR_GR00T_VL_NORM1,
    LLM_TENSOR_GR00T_VL_NORM3,
    LLM_TENSOR_GR00T_VL_FFN_IN,
    LLM_TENSOR_GR00T_VL_FFN_OUT,
    LLM_TENSOR_GR00T_STATE_1,
    LLM_TENSOR_GR00T_STATE_2,
    LLM_TENSOR_GR00T_ACTION_1,
    LLM_TENSOR_GR00T_ACTION_2,
    LLM_TENSOR_GR00T_ACTION_3,
    LLM_TENSOR_GR00T_POSITION,
    LLM_TENSOR_GR00T_TIME_1,
    LLM_TENSOR_GR00T_TIME_2,
    LLM_TENSOR_GR00T_DIT_Q,
    LLM_TENSOR_GR00T_DIT_K,
    LLM_TENSOR_GR00T_DIT_V,
    LLM_TENSOR_GR00T_DIT_OUT,
    LLM_TENSOR_GR00T_DIT_NORM,
    LLM_TENSOR_GR00T_DIT_FFN_IN,
    LLM_TENSOR_GR00T_DIT_FFN_OUT,
    LLM_TENSOR_GR00T_PROJ_OUT_1,
    LLM_TENSOR_GR00T_PROJ_OUT_2,
    LLM_TENSOR_GR00T_DECODER_1,
    LLM_TENSOR_GR00T_DECODER_2,
    LLM_TENSOR_ATTN_NORM_DENSE, // pi05
    LLM_TENSOR_FFN_NORM_DENSE,  // pi05

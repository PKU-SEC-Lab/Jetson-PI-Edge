...
struct llm_build_pi0 : public llm_graph_context {
    llm_build_pi0(const llama_model & model, const llm_graph_params & params);
};

struct llm_build_pi0_ae : public llm_graph_context {
    llm_build_pi0_ae(const llama_model & model, const llm_graph_params & params);
};
...
struct llama_model_pi0 : public llama_model_base {
    llama_model_pi0(const struct llama_model_params & params) : llama_model_base(params) {}
    void load_arch_hparams(llama_model_loader & ml) override;
    void load_arch_tensors(llama_model_loader & ml) override;

...
struct server_routes {
    ...
    server_http_context::handler_t post_foreground_image;
    server_http_context::handler_t put_foreground_state;
    server_http_context::handler_t post_foreground_infer;
    server_http_context::handler_t post_foreground_reset;
    server_http_context::handler_t get_foreground_session;

...
int llama_server(int argc, char ** argv) {
    ...
    ctx_http.post("/foreground/image",         ex_wrapper(routes.post_foreground_image));
    ctx_http.put ("/foreground/state",         ex_wrapper(routes.put_foreground_state));
    ctx_http.post("/foreground/infer",         ex_wrapper(routes.post_foreground_infer));
    ctx_http.post("/foreground/reset",         ex_wrapper(routes.post_foreground_reset));
    ctx_http.get ("/foreground/session",       ex_wrapper(routes.get_foreground_session));

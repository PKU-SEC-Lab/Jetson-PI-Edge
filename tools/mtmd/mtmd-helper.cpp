...
void mtmd_pi0_result_apply_vit_perf(mtmd_context *, mtmd_pi0_result *) {}
...
extern "C" void mtmd_pi0_result_free_pi0_legacy(mtmd_pi0_result * result);

void mtmd_pi0_result_free(mtmd_pi0_result * result) {
    mtmd_pi0_result_free_pi0_legacy(result);
}
...
int32_t mtmd_helper_eval_chunks_pi0(mtmd_context * ctx,
        ...
        llama_pos * new_n_past,
        mtmd_pi0_result * pi0_result) {
    if (pi_model_kind_is_pi05(pi_model_kind_from_env())) {
        return mtmd_helper_eval_chunks_pi0_pi05_adapter(ctx, lctx, chunks, n_past, seq_id, n_batch, logits_last, new_n_past, pi0_result);
    }
    return mtmd_helper_eval_chunks_pi0_legacy(ctx, lctx, chunks, n_past, seq_id, n_batch, logits_last, new_n_past, pi0_result);
}

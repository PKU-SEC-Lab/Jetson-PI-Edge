            ...
            case PROJECTOR_TYPE_PI0:
                {
                    ...
                    if (pi_model_use_pi05_adapters_by_default(kind)) {
                        image_preproc = std::make_unique<mtmd_image_preprocessor_pi05_openpi>(ctx_v);
                    } else {
                        image_preproc = std::make_unique<mtmd_image_preprocessor_pi0_legacy>(ctx_v);
                        ov_img_first = true;
                    }
                } break;

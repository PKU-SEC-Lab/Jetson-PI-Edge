...
struct clip_pi0_vit_perf {
    double preprocess_slice_ms    = 0;
    double preprocess_normalize_ms = 0;
    double preprocess_total_ms    = 0;
    double graph_build_alloc_ms   = 0;
    double set_inputs_ms          = 0;
    double graph_compute_ms       = 0;
    double output_get_ms          = 0;
    double encode_total_ms        = 0;
    bool   graph_reused           = false;
};

const struct clip_pi0_vit_perf * clip_get_last_pi0_vit_perf(const struct clip_ctx * ctx);
void clip_pi0_invalidate_graph_cache(struct clip_ctx * ctx);

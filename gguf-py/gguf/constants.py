...
class MODEL_TENSOR(IntEnum):
    ACTION_IN            = auto() #pi0
    ACTION_OUT           = auto() #pi0
    ACTION_TIME_IN       = auto() #pi0
    ACTION_TIME_OUT      = auto() #pi0
    STATE_PROJ           = auto() #pi0
    TIME_MLP_IN          = auto() #pi05
    TIME_MLP_OUT         = auto() #pi05
    AE_OUTPUT_NORM_DENSE = auto() #pi05
    ATTN_NORM_DENSE      = auto() #pi05
    FFN_NORM_DENSE       = auto() #pi05
    TOKEN_EMBD           = auto()
...
TENSOR_NAMES: dict[MODEL_TENSOR, str] = {
    MODEL_TENSOR.ACTION_IN:                 "action_in_proj" , #PI0
    MODEL_TENSOR.ACTION_OUT:                "action_out_proj" , #PI0
    MODEL_TENSOR.ACTION_TIME_IN:            "action_time_mlp_in" , #PI0
    MODEL_TENSOR.ACTION_TIME_OUT:           "action_time_mlp_out" , #PI0
    MODEL_TENSOR.STATE_PROJ:                "state_proj" , #PI0
    MODEL_TENSOR.TIME_MLP_IN:               "time_mlp_in" , #PI05
    MODEL_TENSOR.TIME_MLP_OUT:              "time_mlp_out" , #PI05
    MODEL_TENSOR.AE_OUTPUT_NORM_DENSE:      "ae_output_norm_dense" , #PI05
    MODEL_TENSOR.ATTN_NORM_DENSE:           "blk.{bid}.attn_norm_dense" , #PI05
    MODEL_TENSOR.FFN_NORM_DENSE:            "blk.{bid}.ffn_norm_dense" , #PI05

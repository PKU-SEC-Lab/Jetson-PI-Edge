...
class TensorNameMap:
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.ATTN_NORM: (
            ...
            "ae.model.layers.{bid}.input_layernorm",                   # pi0
        ...
        MODEL_TENSOR.ATTN_Q: (
            ...
            "ae.model.layers.{bid}.self_attn.q_proj",                       # pi0
        ...
        MODEL_TENSOR.ATTN_K: (
            ...
            "ae.model.layers.{bid}.self_attn.k_proj",                     # pi0
        ...
        MODEL_TENSOR.ATTN_V: (
            ...
            "ae.model.layers.{bid}.self_attn.v_proj",                       # pi0
        ...
        MODEL_TENSOR.ATTN_OUT: (
            ...
            "ae.model.layers.{bid}.self_attn.o_proj",                          # pi0
        ...
        MODEL_TENSOR.ATTN_POST_NORM: (
            ...
            # 'ae.model.layers.0.post_attention_layernorm.weight'
        ...
        MODEL_TENSOR.FFN_NORM: (
            ...
            "ae.model.layers.{bid}.post_attention_layernorm",                # pi0
        ...
        MODEL_TENSOR.FFN_UP: (
            ...
            "ae.model.layers.{bid}.mlp.up_proj",                         # pi0
        ...
        MODEL_TENSOR.FFN_GATE: (
            ...
            "ae.model.layers.{bid}.mlp.gate_proj",               # pi0
        ...
        MODEL_TENSOR.FFN_DOWN: (
            ...
            "ae.model.layers.{bid}.mlp.down_proj",                       # pi0
